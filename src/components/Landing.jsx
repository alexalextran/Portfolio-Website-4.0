  ...
  return (
    <section id="landing">
      ...
      <div className="landing__text">
        ...
        <p>
          Im a Computer Science Student Who Aspires To Specialize In Front End
          Development
        </p>

        <div className="socials">
          <a href="https://github.com/alexalextran" target="_blank">
            <svg
              className="social__icon clickable"
