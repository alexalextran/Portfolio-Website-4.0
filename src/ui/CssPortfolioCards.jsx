...
const Cssportfoliocards = () => {
    return (
        <div>
             <Portfoliocard text="This was my first ever website, and while, its not much, looking back, it shows me how far i've come, from basic text to messing around with api's and building responsive websites" image={eport1}/>
            ...
            <Portfoliocard text="The third redesign of my eportfolio, this attempted the redesign when i was fairly confident at css, since i hated the look of the of the second design, so this page comes complete with a very nice looking Ui" features="Css Animations, Clean Ui, Onhover Effects, Css only Image Carousel" image={eport3}/>
            <Portfoliocard text="This was a small little side project, that i wanted to make to store all some of my thoughts. This was my second website that utilized both HTML and CSS, while it was a side project, it did help me alot with understanding the box model for CSS" features="Theme Integration, OnHover Effects." image={phil}/>
        </div>
    );
}
